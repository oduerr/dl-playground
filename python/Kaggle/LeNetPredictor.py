...
if __name__ == "__main__":
    ...
    if (sys.platform == 'darwin'):
        ...
        fout = open("/home/dueo/data_kaggel_bowl/mid_sized_submission.csv", 'w');
    ...
    head = fc.next()
    classesasreadonserver = pred.names


    # Sorting accoring to Kaggle
    c = -1
    idx = [-1] * (len(head) - 1)
